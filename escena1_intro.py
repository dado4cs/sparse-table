...
class Escena1_Intro(Scene):
    def construct(self):
        ...
        subtitle = Text("Ideal para consultas de rango en arreglos estáticos", font_size=28, color=LIGHT_GREY)
        
        members = Text("Integrantes:\n- Integrante 1\n- Integrante 2\n- Integrante 3", font_size=24, color=WHITE)
        ...
        p1 = Text("1. Precalcula respuestas para rangos en potencias de 2.", font_size=28)
        p2 = Text("2. Permite responder consultas superponiendo dos bloques.", font_size=28)
        p3 = Text("3. Perfecta para operaciones idempotentes: Mínimo, Máximo, GCD.", font_size=28)
